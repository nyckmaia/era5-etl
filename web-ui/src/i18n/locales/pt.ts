...
export const pt = {
  ...
  runProgress: {
    ...
    table: {
      ...
      speed: "MB/s",
      size: "Tamanho",
      sortHint: "Clique para inverter a ordem das linhas",
      totalHint: "Tempo total: da requisição até o fim do download",
      waitHint:
        "Espera: do envio da requisição até o início do download (fila + processamento no servidor remoto)",
      downloadHint: "Download: do início ao fim da transferência do arquivo",
      speedHint: "Velocidade média de download (MB/s) durante a transferência",
      sizeHint: "Tamanho do arquivo baixado (ZIP ou NetCDF)",
    },
    chart: {
      title: "Tempos por chunk",
      xChunk: "Chunk (índice)",
      yTime: "Tempo (min)",
      y2Speed: "MB/s",
      curveTotal: "Total (req → fim)",
      curveWait: "Espera (req → início)",
      curveDownload: "Download (início → fim)",
      curveSpeed: "MB/s (média)",
      empty: "Aguardando o primeiro chunk concluir…",
  ...
  notebooks: {
    ...
    runs: {
      ...
      inputs: {
        button: "Ver inputs do treino",
        title: "Inputs do treino",
        station: "Estação",
        period: "Período",
        target: "Variável alvo",
        era5Vars: "Variáveis ERA5-LAND ativas ({{count}})",
        xgbParams: "Hiperparâmetros XGBoost",
        copy: "Copiar configuração",
        copied: "Configuração copiada",
        close: "Fechar",
        legacy: "Run antigo: nem todos os inputs foram registrados.",
      },
    },
  },
};
